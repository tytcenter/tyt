...
class NominaLiquidaciones(models.TransientModel):
    ...
    def generate_liquidaciones_report(self):
        ...
        if ctx.get('active_ids'):
            ...
            return self.env.ref('nomina_cfdi_extras_ee.report_nomina_liquidaciones').report_action(self, data=datas)

class LiquidacionesReport(models.AbstractModel):
    _name = "report.nomina_cfdi_extras_ee.report_liquidaciones_document"
