...
#                payslip_total_TDED += round(self.importe_imss,2)
        ...
        request_params.update({
                ...
                'nomina12': {
                      ...
                      'TotalPercepciones': self.set_decimals(payslip_total_PERG + payslip_total_PERE,2),
                      'TotalDeducciones': self.set_decimals(self.descuento,2),
                      'TotalOtrosPagos': self.set_decimals(payslip_total_TOP,2),
